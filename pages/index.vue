<template>
            <section class="resume-section flex-col" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0 text-5xl md:text-9xl font-saira">
                        Kevin
                        <span class="text-primary">Monestel Amador</span>
                    </h1>
                    <div class="subheading mb-5 text-expanded">
                    ...
                    <p class="lead mb-5 italic">"Bachiller como Ingeniero en Sistemas Computacionales. Me apasiona el mundo de la tecnología y el desarrollo e implementación de sistemas informáticos en tecnologías de Microsoft.
